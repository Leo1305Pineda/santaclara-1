...
public class PresentacionesUI extends JPanel {
	...
	public PresentacionesUI(ContPresentaciones contPresentaciones,List<Presentacion> presentaciones) {
		...
		pnPresentaciones.setBounds(12, 12, 420, 312);
		...
		panel.setBounds(12, 37, 400, 45);
		pnPresentaciones.add(panel);
		panel.setLayout(null);
		
		pnOpciones = new JPanel();
		pnOpciones.setBounds(0, 0, 400, 34);
		...
		btnNuevo.setBounds(100, 15, 92, 16);
		...
		btnEditar.setBounds(195, 15, 92, 16);
		...
		btnSalir.setBounds(290, 15, 92, 16);
		btnSalir.setForeground(Color.WHITE);
		btnSalir.setBackground(Color.DARK_GRAY);
		pnOpciones.add(btnSalir);
		
		pnTabla = new JPanel();
		pnTabla.setBounds(12, 81, 400, 181);
		pnPresentaciones.add(pnTabla);
		pnTabla.setLayout(null);
		
		scrollPanel = new JScrollPane();
		scrollPanel.setBounds(0, 0, 400, 179);
		...
		panel_1.setBounds(12, 12, 400, 30);
		...
		pnPresentacion.setBounds(12, 270, 400, 30);
		...
		btnGuardar.setBounds(305, 5, 92, 16);
		...
		btnCancelar.setBounds(5, 5, 92, 16);
		...
		label.setBounds(100, 0, 69, 25);
		pnPresentacion.add(label);
		
		txtNombre = new JTextField();
		txtNombre.setColumns(10);
		txtNombre.setBounds(171, 5, 121, 16);
	...
	public void activarNuevoPresentacion() {
		...
		pnPresentacion.setBounds(12, 81, 400, 30);
		setTxtNombre("");
